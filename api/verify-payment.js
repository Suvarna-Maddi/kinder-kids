    ...
    if (isAuthentic) {
      ...
      await db.runTransaction(async (transaction) => {
        ...
        if (userDoc.exists) {
          ...
          if (userData.isPremium && userData.subscriptionExpiryDate && userData.subscriptionExpiryDate.toMillis() > now.toMillis()) {
      ...
      return res.status(200).json({ success: true, message: 'Payment verified successfully and saved' });
    } else {
