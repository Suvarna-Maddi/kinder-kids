...
export const Route = createFileRoute("/playzone")({
  ...
  head: () => {
    const canonicalUrl = "https://kinderkidsspace.in/playzone";
    const schema = {
    ...
    return {
      meta: [
        ...
        },
        {
          name: "keywords",
          content:
            "Educational games for kids, Play and learn, Kids memory games, Animal games for children, Fun learning activities",
        },
        {
          property: "og:title",
          content: "PlayZone — Fun Learning Games for Kids | KinderKidsSpace",
        },
        {
