...
export const Route = createFileRoute("/solarsystem")({
  ...
  head: () => {
    const canonicalUrl = "https://kinderkidsspace.in/solarsystem";
    const schema = {
      "@context": "https://schema.org",
      "@type": "Course",
      name: "Solar System — Explore Planets",
      description:
        "Learn about planets and the solar system through interactive activities for children.",
      provider: {
    ...
    return {
      meta: [
        ...
        },
        {
          name: "keywords",
          content:
            "Solar system for kids, Learn planets, Space exploration for children, Educational science games",
        },
