...
export const Route = createFileRoute("/tables")({
  ...
  head: () => {
    const canonicalUrl = "https://kinderkidsspace.in/tables";
    const schema = {
    ...
    return {
      meta: [
        ...
        },
        {
          name: "keywords",
          content:
            "Times tables for kids, Learn multiplication, Multiplication practice, Kids math tables",
        },
        {
          property: "og:title",
          content: "Times Tables — Multiplication Practice | KinderKidsSpace",
        },
        {
