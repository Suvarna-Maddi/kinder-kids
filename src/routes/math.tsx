...
export const Route = createFileRoute("/math")({
  ...
  head: () => {
    ...
    const schema = {
      ...
      "description": "Practice addition, subtraction, multiplication and division with unlimited kid-friendly questions.",
      "provider": {
    ...
    return {
      meta: [
        ...
        { name: "keywords", content: "Kids math, Arithmetic for kids, Learn addition, Learn subtraction, Educational math games, Math practice for children" },
        { property: "og:title", content: "Mathematics — Fun Arithmetic for Kids | KinderKidsSpace" },
        {
          property: "og:description",
          content: "Unlimited arithmetic practice with narration and rewards. Perfect for young learners.",
        },
