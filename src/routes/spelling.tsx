  ...
  head: () => {
    ...
    return {
      meta: [
        ...
        { name: "description", content: "Interactive spelling games and activities for children. Improve vocabulary and spelling skills." },
        { name: "keywords", content: "Spelling games for kids, Learn to spell, Preschool spelling, Kindergarten vocabulary, Educational games for children" },
        { property: "og:title", content: "Spelling Games — Learn to Spell | KinderKidsSpace" },
        { property: "og:description", content: "Interactive spelling games and activities for children. Improve vocabulary and spelling skills." },
