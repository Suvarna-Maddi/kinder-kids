...
const PATH_OCTAGON = "M 30 8 L 70 8 L 92 30 L 92 70 L 70 92 L 30 92 L 8 70 L 8 30 Z";
const PATH_ARROW = "M 8 40 L 55 40 L 55 20 L 92 50 L 55 80 L 55 60 L 8 60 Z";
const PATH_CROSS =
  "M 40 10 L 60 10 L 60 40 L 90 40 L 90 60 L 60 60 L 60 90 L 40 90 L 40 60 L 10 60 L 10 40 L 40 40 Z";
const PATH_CRESCENT = "M 70 15 A 40 40 0 1 0 70 85 A 30 30 0 1 1 70 15 Z";
const PATH_SEMI = "M 10 60 A 40 40 0 0 1 90 60 L 90 62 L 10 62 Z";
...
const shape = (
  ...
  cat: "2d" | "3d",
  color: string,
  render: ShapeDef["render"],
  strokes: string[],
): Omit<ShapeDef, "name"> => ({ label, description: desc, category: cat, color, render, strokes });
...
const SHAPES: ShapeDef[] = [
  ...
  },
  {
    ...
    ...shape(
      "Square",
      "Four equal sides and four corners.",
      "2d",
      "text-kid-green",
      (f, s) => (
        <rect x={15} y={15} width={70} height={70} fill={f} stroke={s} strokeWidth={4} rx={4} />
      ),
  ...
  },
  {
    ...
    ...shape(
      ...
      "text-kid-orange",
      (f, s) => (
        <path d={PATH_TRIANGLE} fill={f} stroke={s} strokeWidth={4} strokeLinejoin="round" />
      ),
      [PATH_TRIANGLE],
    ),
  },
  {
    ...
    ...shape(
      ...
      "text-kid-purple",
      (f, s) => (
        <rect x={8} y={25} width={84} height={50} fill={f} stroke={s} strokeWidth={4} rx={4} />
      ),
  ...
  },
  {
    ...
    ...shape(
      "Star",
      "A shape with five sparkling points.",
      "2d",
      "text-kid-yellow",
  ...
  },
  {
    ...
    ...shape(
      ...
      "text-kid-teal",
      (f, s) => (
        <path d={PATH_PENTAGON} fill={f} stroke={s} strokeWidth={4} strokeLinejoin="round" />
      ),
      [PATH_PENTAGON],
    ),
  },
  {
    ...
    ...shape(
      "Hexagon",
      "Six sides like a honeycomb.",
      "2d",
      "text-kid-blue",
      (f, s) => (
        <path d={PATH_HEXAGON} fill={f} stroke={s} strokeWidth={4} strokeLinejoin="round" />
      ),
      [PATH_HEXAGON],
    ),
  },
  {
    ...
    ...shape(
      "Oval",
      "Like a stretched circle, like an egg.",
      "2d",
      "text-kid-red",
  ...
  },
  {
    ...
    ...shape(
      "Diamond",
      "A square standing on its point.",
      "2d",
      "text-kid-purple",
      (f, s) => (
        <path d={PATH_DIAMOND} fill={f} stroke={s} strokeWidth={4} strokeLinejoin="round" />
      ),
      [PATH_DIAMOND],
    ),
  },
  {
    ...
    ...shape(
      "Rhombus",
      "Four equal sides, tilted like a kite.",
      "2d",
      "text-kid-pink",
      (f, s) => (
        <path d={PATH_RHOMBUS} fill={f} stroke={s} strokeWidth={4} strokeLinejoin="round" />
      ),
      [PATH_RHOMBUS],
    ),
  },
  ...
  },
  {
    ...
    ...shape(
      "Trapezium",
      "Two parallel sides, one long, one short.",
      "2d",
      "text-kid-orange",
      (f, s) => (
        <path d={PATH_TRAPEZIUM} fill={f} stroke={s} strokeWidth={4} strokeLinejoin="round" />
      ),
      [PATH_TRAPEZIUM],
    ),
  },
  ...
  },
  {
    ...
    ...shape(
      "Octagon",
      "Eight sides like a stop sign.",
      "2d",
      "text-kid-red",
      (f, s) => (
        <path d={PATH_OCTAGON} fill={f} stroke={s} strokeWidth={4} strokeLinejoin="round" />
      ),
      [PATH_OCTAGON],
    ),
  },
  ...
  },
  {
    ...
    ...shape(
      ...
      "text-kid-yellow",
      (f, s) => (
        <path d={PATH_CRESCENT} fill={f} stroke={s} strokeWidth={4} strokeLinejoin="round" />
      ),
      [PATH_CRESCENT],
    ),
  },
  ...
  // 3D
  {
    ...
    ...shape(
      "Cube",
      "A 3D box with six equal square faces.",
      "3d",
      "text-kid-blue",
      (f, s) => (
        <g>
  ...
  },
  {
    ...
    ...shape(
      "Cylinder",
      "A tube with round ends, like a can.",
      "3d",
      "text-kid-orange",
      (f, s) => (
        <g>
  ...
  },
  {
    ...
    ...shape(
      "Cone",
      "A pointy top on a round base, like an ice-cream cone.",
      "3d",
      "text-kid-yellow",
      (f, s) => (
        <g>
  ...
  },
  {
    ...
    ...shape(
      "Pyramid",
      "Triangle faces meeting at a point.",
      "3d",
      "text-kid-purple",
      (f, s) => (
        <g>
...
const ShapeTracePad = ({
  ...
  const move = (e: React.PointerEvent) => {
    ...
    ctx.lineCap = "round";
    ctx.lineJoin = "round";
    ctx.strokeStyle = "hsl(var(--kid-blue))";
    ctx.lineWidth = 14;
    ctx.beginPath();
  ...
  const reset = () => {
    samplesRef.current.forEach((p) => (p.hit = false));
    setCoverage(0);
    setSucceeded(false);
    clearCanvas();
  };
...
const ShapesGame = () => {
  ...
  useEffect(() => {
    if (mode === "quiz") nextQuiz(); /* eslint-disable-next-line */
  }, [mode]);
  useEffect(() => {
  ...
  return (
    <div className="p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        {(mode === "learn" || mode === "trace" || mode === "draw") && (
          <>
            <AnimatePresence>
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${GRADIENTS[SHAPES.indexOf(selected) % GRADIENTS.length]} opacity-10 pointer-events-none`}
                />
                <div className="relative z-10">
                  {mode === "learn" ? (
                    <>
                      ...
                      <p className="text-lg md:text-xl font-body text-muted-foreground max-w-md mx-auto">
            ...
            <div className="mb-2 text-sm font-body text-muted-foreground font-semibold">
              2D Shapes
            </div>
              ...
              {SHAPES.filter((s) => s.category === "2d").map((s, i) => (
                <motion.button
                  ...
                  onClick={() => {
                    playPop();
                    setSelected(s);
                    if (mode === "learn") handlePickShape(s);
        ...
        {mode === "quiz" && quiz && (
          <motion.div
            key={`quiz-${quiz.target.name}-${total}`}
              ...
              {quiz.options.map((s) => {
                ...
                return (
                  ...
                  >
                    ...
                    {showResult && s.name === quiz.target.name && (
                      <Check className="w-5 h-5 text-accent mt-1" />
                    )}
                    {showResult && isPicked && s.name !== quiz.target.name && (
                      <XIcon className="w-5 h-5 text-destructive mt-1" />
                    )}
                  </motion.button>
                );
              })}
